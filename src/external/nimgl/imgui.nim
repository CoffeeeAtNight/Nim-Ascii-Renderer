...
# TypeDefs
type
  ImDrawCallback* = proc(parent_list: ptr ImDrawList,
      cmd: ptr ImDrawCmd): void {.cdecl, varargs.}
  ImDrawIdx* = uint16
  ImFileHandle* = ptr FILE
  ImGuiContextHookCallback* = proc(ctx: ptr ImGuiContext,
      hook: ptr ImGuiContextHook): void {.cdecl, varargs.}
  ImGuiErrorLogCallback* = proc(user_data: pointer,
      fmt: cstring): void {.cdecl.}
  ImGuiID* = uint32
  ...
  ImDrawListSharedData* {.importc: "ImDrawListSharedData",
      imgui_header.} = object
  ...
  ImFontAtlasCustomRect* {.importc: "ImFontAtlasCustomRect",
      imgui_header.} = object
  ...
  ImGuiComboPreviewData* {.importc: "ImGuiComboPreviewData",
      imgui_header.} = object
  ...
  ImGuiContext* {.importc: "ImGuiContext", imgui_header.} = object
    ...
    withinFrameScopeWithImplicitWindow *
      {.importc: "WithinFrameScopeWithImplicitWindow".}: bool
    ...
    windowsFocusOrder* {.importc: "WindowsFocusOrder".}: ImVector[
        ptr ImGuiWindow]
  ...
  ImGuiGroupData* {.importc: "ImGuiGroupData", imgui_header.} = object
    ...
    backupActiveIdPreviousFrameIsAlive *
      {.importc: "BackupActiveIdPreviousFrameIsAlive".}: bool
  ...
  ImGuiIO* {.importc: "ImGuiIO", imgui_header.} = object
    ...
    imeSetInputScreenPosFn* {.importc: "ImeSetInputScreenPosFn".}: proc(
        x: int32, y: int32): void {.cdecl, varargs.}
    ...
    navInputsDownDurationPrev* {.importc: "NavInputsDownDurationPrev".}: array[
        20, float32]
  ...
  ImGuiSettingsHandler* {.importc: "ImGuiSettingsHandler",
      imgui_header.} = object
    ...
    readOpenFn* {.importc: "ReadOpenFn".}: proc(ctx: ptr ImGuiContext,
        handler: ptr ImGuiSettingsHandler, name: cstring): pointer {.cdecl, varargs.}
    readLineFn* {.importc: "ReadLineFn".}: proc(ctx: ptr ImGuiContext,
        handler: ptr ImGuiSettingsHandler, entry: pointer,
        line: cstring): void {.cdecl, varargs.}
    applyAllFn* {.importc: "ApplyAllFn".}: proc(ctx: ptr ImGuiContext,
        handler: ptr ImGuiSettingsHandler): void {.cdecl, varargs.}
    writeAllFn* {.importc: "WriteAllFn".}: proc(ctx: ptr ImGuiContext,
        handler: ptr ImGuiSettingsHandler,
        out_buf: ptr ImGuiTextBuffer): void {.cdecl, varargs.}
    userData* {.importc: "UserData".}: pointer
  ImGuiShrinkWidthItem* {.importc: "ImGuiShrinkWidthItem",
      imgui_header.} = object
    index* {.importc: "Index".}: int32
    width* {.importc: "Width".}: float32
  ImGuiSizeCallbackData* {.importc: "ImGuiSizeCallbackData",
      imgui_header.} = object
    userData* {.importc: "UserData".}: pointer
    pos* {.importc: "Pos".}: ImVec2
  ...
  ImGuiWindowSettings* {.importc: "ImGuiWindowSettings", imgui_header.} = object
    ...
    collapsed* {.importc: "Collapsed".}: bool
    wantApply* {.importc: "WantApply".}: bool
  ImGuiWindowStackData* {.importc: "ImGuiWindowStackData",
      imgui_header.} = object
    window* {.importc: "Window".}: ptr ImGuiWindow
...
proc setBitRange*(self: ptr uint32, n: int32,
    n2: int32): void {.importc: "ImBitArray_SetBitRange".}
...
proc alloc_chunk*[T](self: ptr ImChunkStream,
    sz: uint): ptr T {.importc: "ImChunkStream_alloc_chunk".}
proc begin*[T](self: ptr ImChunkStream): ptr T {.importc: "ImChunkStream_begin".}
proc chunk_size*[T](self: ptr ImChunkStream,
    p: ptr T): int32 {.importc: "ImChunkStream_chunk_size".}
...
proc next_chunk*[T](self: ptr ImChunkStream,
    p: ptr T): ptr T {.importc: "ImChunkStream_next_chunk".}
proc offset_from_ptr*[T](self: ptr ImChunkStream,
    p: ptr T): int32 {.importc: "ImChunkStream_offset_from_ptr".}
proc ptr_from_offset*[T](self: ptr ImChunkStream,
    off: int32): ptr T {.importc: "ImChunkStream_ptr_from_offset".}
...
proc hSVNonUDT*(pOut: ptr ImColor, h: float32, s: float32, v: float32,
    a: float32 = 1.0f): void {.importc: "ImColor_HSV".}
proc newImColor*(): void {.importc: "ImColor_ImColor_Nil".}
proc newImColor*(r: int32, g: int32, b: int32,
    a: int32 = 255): void {.importc: "ImColor_ImColor_Int".}
proc newImColor*(rgba: uint32): void {.importc: "ImColor_ImColor_U32".}
proc newImColor*(r: float32, g: float32, b: float32,
    a: float32 = 1.0f): void {.importc: "ImColor_ImColor_Float".}
proc newImColor*(col: ImVec4): void {.importc: "ImColor_ImColor_Vec4".}
proc setHSV*(self: ptr ImColor, h: float32, s: float32, v: float32,
    a: float32 = 1.0f): void {.importc: "ImColor_SetHSV".}
...
proc scaleClipRects*(self: ptr ImDrawData,
    fb_scale: ImVec2): void {.importc: "ImDrawData_ScaleClipRects".}
...
proc setCircleTessellationMaxError*(self: ptr ImDrawListSharedData,
    max_error: float32): void {.importc: "ImDrawListSharedData_SetCircleTessellationMaxError".}
...
proc merge*(self: ptr ImDrawListSplitter,
    draw_list: ptr ImDrawList): void {.importc: "ImDrawListSplitter_Merge".}
proc setCurrentChannel*(self: ptr ImDrawListSplitter, draw_list: ptr ImDrawList,
    channel_idx: int32): void {.importc: "ImDrawListSplitter_SetCurrentChannel".}
proc split*(self: ptr ImDrawListSplitter, draw_list: ptr ImDrawList,
    count: int32): void {.importc: "ImDrawListSplitter_Split".}
...
proc addBezierCubic*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    ...
    num_segments: int32 = 0): void {.importc: "ImDrawList_AddBezierCubic".}
proc addBezierQuadratic*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2,
    p3: ImVec2, col: uint32, thickness: float32,
    num_segments: int32 = 0): void {.importc: "ImDrawList_AddBezierQuadratic".}
proc addCallback*(self: ptr ImDrawList, callback: ImDrawCallback,
    callback_data: pointer): void {.importc: "ImDrawList_AddCallback".}
proc addCircle*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32, num_segments: int32 = 0,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddCircle".}
proc addCircleFilled*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32,
    num_segments: int32 = 0): void {.importc: "ImDrawList_AddCircleFilled".}
proc addConvexPolyFilled*(self: ptr ImDrawList, points: ptr ImVec2,
    num_points: int32,
    col: uint32): void {.importc: "ImDrawList_AddConvexPolyFilled".}
proc addDrawCmd*(self: ptr ImDrawList): void {.importc: "ImDrawList_AddDrawCmd".}
proc addImage*(self: ptr ImDrawList, user_texture_id: ImTextureID,
    p_min: ImVec2, p_max: ImVec2, uv_min: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    uv_max: ImVec2 = ImVec2(x: 1, y: 1).ImVec2, col: uint32 = high(
    uint32)): void {.importc: "ImDrawList_AddImage".}
proc addImageQuad*(self: ptr ImDrawList, user_texture_id: ImTextureID,
    p1: ImVec2, p2: ImVec2, p3: ImVec2, p4: ImVec2, uv1: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2, uv2: ImVec2 = ImVec2(x: 1, y: 0).ImVec2, uv3: ImVec2 = ImVec2(
    x: 1, y: 1).ImVec2, uv4: ImVec2 = ImVec2(x: 0, y: 1).ImVec2,
    col: uint32 = high(uint32)): void {.importc: "ImDrawList_AddImageQuad".}
proc addImageRounded*(self: ptr ImDrawList, user_texture_id: ImTextureID,
    p_min: ImVec2, p_max: ImVec2, uv_min: ImVec2, uv_max: ImVec2, col: uint32,
    rounding: float32,
    flags: ImDrawFlags = 0.ImDrawFlags): void {.importc: "ImDrawList_AddImageRounded".}
proc addLine*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, col: uint32,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddLine".}
proc addNgon*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32, num_segments: int32,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddNgon".}
proc addNgonFilled*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    col: uint32,
    num_segments: int32): void {.importc: "ImDrawList_AddNgonFilled".}
proc addPolyline*(self: ptr ImDrawList, points: ptr ImVec2, num_points: int32,
    col: uint32, flags: ImDrawFlags,
    thickness: float32): void {.importc: "ImDrawList_AddPolyline".}
proc addQuad*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    p4: ImVec2, col: uint32,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddQuad".}
proc addQuadFilled*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    p4: ImVec2, col: uint32): void {.importc: "ImDrawList_AddQuadFilled".}
proc addRect*(self: ptr ImDrawList, p_min: ImVec2, p_max: ImVec2, col: uint32,
    rounding: float32 = 0.0f, flags: ImDrawFlags = 0.ImDrawFlags,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddRect".}
proc addRectFilled*(self: ptr ImDrawList, p_min: ImVec2, p_max: ImVec2,
    col: uint32, rounding: float32 = 0.0f,
    flags: ImDrawFlags = 0.ImDrawFlags): void {.importc: "ImDrawList_AddRectFilled".}
proc addRectFilledMultiColor*(self: ptr ImDrawList, p_min: ImVec2,
    p_max: ImVec2, col_upr_left: uint32, col_upr_right: uint32,
    col_bot_right: uint32,
    col_bot_left: uint32): void {.importc: "ImDrawList_AddRectFilledMultiColor".}
proc addText*(self: ptr ImDrawList, pos: ImVec2, col: uint32,
    text_begin: cstring,
    text_end: cstring = nil): void {.importc: "ImDrawList_AddText_Vec2".}
proc addText*(self: ptr ImDrawList, font: ptr ImFont, font_size: float32,
    pos: ImVec2, col: uint32, text_begin: cstring, text_end: cstring = nil,
    wrap_width: float32 = 0.0f,
    cpu_fine_clip_rect: ptr ImVec4 = nil): void {.importc: "ImDrawList_AddText_FontPtr".}
proc addTriangle*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2,
    col: uint32,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_AddTriangle".}
proc addTriangleFilled*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2,
    p3: ImVec2, col: uint32): void {.importc: "ImDrawList_AddTriangleFilled".}
proc channelsMerge*(self: ptr ImDrawList): void {.importc: "ImDrawList_ChannelsMerge".}
proc channelsSetCurrent*(self: ptr ImDrawList,
    n: int32): void {.importc: "ImDrawList_ChannelsSetCurrent".}
proc channelsSplit*(self: ptr ImDrawList,
    count: int32): void {.importc: "ImDrawList_ChannelsSplit".}
proc cloneOutput*(self: ptr ImDrawList): ptr ImDrawList {.importc: "ImDrawList_CloneOutput".}
proc getClipRectMaxNonUDT*(pOut: ptr ImVec2,
    self: ptr ImDrawList): void {.importc: "ImDrawList_GetClipRectMax".}
proc getClipRectMinNonUDT*(pOut: ptr ImVec2,
    self: ptr ImDrawList): void {.importc: "ImDrawList_GetClipRectMin".}
...
proc pathArcTo*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    a_min: float32, a_max: float32,
    num_segments: int32 = 0): void {.importc: "ImDrawList_PathArcTo".}
proc pathArcToFast*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    a_min_of_12: int32,
    a_max_of_12: int32): void {.importc: "ImDrawList_PathArcToFast".}
proc pathBezierCubicCurveTo*(self: ptr ImDrawList, p2: ImVec2, p3: ImVec2,
    p4: ImVec2,
    num_segments: int32 = 0): void {.importc: "ImDrawList_PathBezierCubicCurveTo".}
proc pathBezierQuadraticCurveTo*(self: ptr ImDrawList, p2: ImVec2, p3: ImVec2,
    num_segments: int32 = 0): void {.importc: "ImDrawList_PathBezierQuadraticCurveTo".}
proc pathClear*(self: ptr ImDrawList): void {.importc: "ImDrawList_PathClear".}
proc pathFillConvex*(self: ptr ImDrawList,
    col: uint32): void {.importc: "ImDrawList_PathFillConvex".}
proc pathLineTo*(self: ptr ImDrawList, pos: ImVec2): void {.importc: "ImDrawList_PathLineTo".}
proc pathLineToMergeDuplicate*(self: ptr ImDrawList,
    pos: ImVec2): void {.importc: "ImDrawList_PathLineToMergeDuplicate".}
proc pathRect*(self: ptr ImDrawList, rect_min: ImVec2, rect_max: ImVec2,
    rounding: float32 = 0.0f,
    flags: ImDrawFlags = 0.ImDrawFlags): void {.importc: "ImDrawList_PathRect".}
proc pathStroke*(self: ptr ImDrawList, col: uint32,
    flags: ImDrawFlags = 0.ImDrawFlags,
    thickness: float32 = 1.0f): void {.importc: "ImDrawList_PathStroke".}
...
proc primQuadUV*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2,
    d: ImVec2, uv_a: ImVec2, uv_b: ImVec2, uv_c: ImVec2, uv_d: ImVec2,
    col: uint32): void {.importc: "ImDrawList_PrimQuadUV".}
proc primRect*(self: ptr ImDrawList, a: ImVec2, b: ImVec2,
    col: uint32): void {.importc: "ImDrawList_PrimRect".}
proc primRectUV*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, uv_a: ImVec2,
    uv_b: ImVec2, col: uint32): void {.importc: "ImDrawList_PrimRectUV".}
proc primReserve*(self: ptr ImDrawList, idx_count: int32,
    vtx_count: int32): void {.importc: "ImDrawList_PrimReserve".}
proc primUnreserve*(self: ptr ImDrawList, idx_count: int32,
    vtx_count: int32): void {.importc: "ImDrawList_PrimUnreserve".}
proc primVtx*(self: ptr ImDrawList, pos: ImVec2, uv: ImVec2,
    col: uint32): void {.importc: "ImDrawList_PrimVtx".}
proc primWriteIdx*(self: ptr ImDrawList,
    idx: ImDrawIdx): void {.importc: "ImDrawList_PrimWriteIdx".}
proc primWriteVtx*(self: ptr ImDrawList, pos: ImVec2, uv: ImVec2,
    col: uint32): void {.importc: "ImDrawList_PrimWriteVtx".}
proc pushClipRect*(self: ptr ImDrawList, clip_rect_min: ImVec2,
    clip_rect_max: ImVec2,
    intersect_with_current_clip_rect: bool = false): void {.importc: "ImDrawList_PushClipRect".}
proc pushClipRectFullScreen*(self: ptr ImDrawList): void {.importc: "ImDrawList_PushClipRectFullScreen".}
proc pushTextureID*(self: ptr ImDrawList,
    texture_id: ImTextureID): void {.importc: "ImDrawList_PushTextureID".}
proc CalcCircleAutoSegmentCount*(self: ptr ImDrawList,
    radius: float32): int32 {.importc: "ImDrawList__CalcCircleAutoSegmentCount".}
...
proc PathArcToFastEx*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    a_min_sample: int32, a_max_sample: int32,
    a_step: int32): void {.importc: "ImDrawList__PathArcToFastEx".}
proc PathArcToN*(self: ptr ImDrawList, center: ImVec2, radius: float32,
    a_min: float32, a_max: float32,
    num_segments: int32): void {.importc: "ImDrawList__PathArcToN".}
...
proc addCustomRectFontGlyph*(self: ptr ImFontAtlas, font: ptr ImFont,
    id: ImWchar, width: int32, height: int32, advance_x: float32,
    offset: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): int32 {.importc: "ImFontAtlas_AddCustomRectFontGlyph".}
proc addCustomRectRegular*(self: ptr ImFontAtlas, width: int32,
    height: int32): int32 {.importc: "ImFontAtlas_AddCustomRectRegular".}
proc addFont*(self: ptr ImFontAtlas, font_cfg: ptr ImFontConfig): ptr ImFont {.importc: "ImFontAtlas_AddFont".}
proc addFontDefault*(self: ptr ImFontAtlas,
    font_cfg: ptr ImFontConfig = nil): ptr ImFont {.importc: "ImFontAtlas_AddFontDefault".}
proc addFontFromFileTTF*(self: ptr ImFontAtlas, filename: cstring,
    size_pixels: float32, font_cfg: ptr ImFontConfig = nil,
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.importc: "ImFontAtlas_AddFontFromFileTTF".}
proc addFontFromMemoryCompressedBase85TTF*(self: ptr ImFontAtlas,
    ...
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.importc: "ImFontAtlas_AddFontFromMemoryCompressedBase85TTF".}
proc addFontFromMemoryCompressedTTF*(self: ptr ImFontAtlas,
    compressed_font_data: pointer, compressed_font_size: int32,
    size_pixels: float32, font_cfg: ptr ImFontConfig = nil,
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.importc: "ImFontAtlas_AddFontFromMemoryCompressedTTF".}
proc addFontFromMemoryTTF*(self: ptr ImFontAtlas, font_data: pointer,
    font_size: int32, size_pixels: float32, font_cfg: ptr ImFontConfig = nil,
    glyph_ranges: ptr ImWchar = nil): ptr ImFont {.importc: "ImFontAtlas_AddFontFromMemoryTTF".}
...
proc calcCustomRectUV*(self: ptr ImFontAtlas, rect: ptr ImFontAtlasCustomRect,
    ...
    out_uv_max: ptr ImVec2): void {.importc: "ImFontAtlas_CalcCustomRectUV".}
...
proc getCustomRectByIndex*(self: ptr ImFontAtlas,
    index: int32): ptr ImFontAtlasCustomRect {.importc: "ImFontAtlas_GetCustomRectByIndex".}
proc getGlyphRangesChineseFull*(self: ptr ImFontAtlas): ptr ImWchar {.importc: "ImFontAtlas_GetGlyphRangesChineseFull".}
proc getGlyphRangesChineseSimplifiedCommon*(
  self: ptr ImFontAtlas): ptr ImWchar {.importc: "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon".}
...
proc addChar*(self: ptr ImFontGlyphRangesBuilder,
    c: ImWchar): void {.importc: "ImFontGlyphRangesBuilder_AddChar".}
proc addRanges*(self: ptr ImFontGlyphRangesBuilder,
    ranges: ptr ImWchar): void {.importc: "ImFontGlyphRangesBuilder_AddRanges".}
proc addText*(self: ptr ImFontGlyphRangesBuilder, text: cstring,
    text_end: cstring = nil): void {.importc: "ImFontGlyphRangesBuilder_AddText".}
proc buildRanges*(self: ptr ImFontGlyphRangesBuilder, out_ranges: ptr ImVector[
    ImWchar]): void {.importc: "ImFontGlyphRangesBuilder_BuildRanges".}
proc clear*(self: ptr ImFontGlyphRangesBuilder): void {.importc: "ImFontGlyphRangesBuilder_Clear".}
proc getBit*(self: ptr ImFontGlyphRangesBuilder,
    n: uint): bool {.importc: "ImFontGlyphRangesBuilder_GetBit".}
proc newImFontGlyphRangesBuilder*(): void {.importc: "ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder".}
proc setBit*(self: ptr ImFontGlyphRangesBuilder,
    n: uint): void {.importc: "ImFontGlyphRangesBuilder_SetBit".}
...
proc addGlyph*(self: ptr ImFont, src_cfg: ptr ImFontConfig, c: ImWchar,
    ...
    v0: float32, u1: float32, v1: float32,
    advance_x: float32): void {.importc: "ImFont_AddGlyph".}
proc addRemapChar*(self: ptr ImFont, dst: ImWchar, src: ImWchar,
    overwrite_dst: bool = true): void {.importc: "ImFont_AddRemapChar".}
...
proc calcTextSizeANonUDT*(pOut: ptr ImVec2, self: ptr ImFont, size: float32,
    max_width: float32, wrap_width: float32, text_begin: cstring,
    text_end: cstring = nil,
    remaining: ptr cstring = nil): void {.importc: "ImFont_CalcTextSizeA".}
proc calcWordWrapPositionA*(self: ptr ImFont, scale: float32, text: cstring,
    text_end: cstring,
    wrap_width: float32): cstring {.importc: "ImFont_CalcWordWrapPositionA".}
...
proc findGlyphNoFallback*(self: ptr ImFont,
    c: ImWchar): ptr ImFontGlyph {.importc: "ImFont_FindGlyphNoFallback".}
...
proc isGlyphRangeUnused*(self: ptr ImFont, c_begin: uint32,
    c_last: uint32): bool {.importc: "ImFont_IsGlyphRangeUnused".}
...
proc renderChar*(self: ptr ImFont, draw_list: ptr ImDrawList, size: float32,
    pos: ImVec2, col: uint32, c: ImWchar): void {.importc: "ImFont_RenderChar".}
proc renderText*(self: ptr ImFont, draw_list: ptr ImDrawList, size: float32,
    pos: ImVec2, col: uint32, clip_rect: ImVec4, text_begin: cstring,
    text_end: cstring, wrap_width: float32 = 0.0f,
    cpu_fine_clip: bool = false): void {.importc: "ImFont_RenderText".}
proc setGlyphVisible*(self: ptr ImFont, c: ImWchar,
    visible: bool): void {.importc: "ImFont_SetGlyphVisible".}
...
proc addInputCharacter*(self: ptr ImGuiIO,
    c: uint32): void {.importc: "ImGuiIO_AddInputCharacter".}
proc addInputCharacterUTF16*(self: ptr ImGuiIO,
    c: ImWchar16): void {.importc: "ImGuiIO_AddInputCharacterUTF16".}
proc addInputCharactersUTF8*(self: ptr ImGuiIO,
    str: cstring): void {.importc: "ImGuiIO_AddInputCharactersUTF8".}
...
proc deleteChars*(self: ptr ImGuiInputTextCallbackData, pos: int32,
    bytes_count: int32): void {.importc: "ImGuiInputTextCallbackData_DeleteChars".}
...
proc insertChars*(self: ptr ImGuiInputTextCallbackData, pos: int32,
    text: cstring,
    text_end: cstring = nil): void {.importc: "ImGuiInputTextCallbackData_InsertChars".}
...
proc onKeyPressed*(self: ptr ImGuiInputTextState,
    key: int32): void {.importc: "ImGuiInputTextState_OnKeyPressed".}
...
proc begin*(self: ptr ImGuiListClipper, items_count: int32,
    items_height: float32 = -1.0f): void {.importc: "ImGuiListClipper_Begin".}
...
proc calcNextTotalWidth*(self: ptr ImGuiMenuColumns,
    update_offsets: bool): void {.importc: "ImGuiMenuColumns_CalcNextTotalWidth".}
proc declColumns*(self: ptr ImGuiMenuColumns, w_icon: float32, w_label: float32,
    w_shortcut: float32,
    w_mark: float32): float32 {.importc: "ImGuiMenuColumns_DeclColumns".}
proc newImGuiMenuColumns*(): void {.importc: "ImGuiMenuColumns_ImGuiMenuColumns".}
proc update*(self: ptr ImGuiMenuColumns, spacing: float32,
    window_reappearing: bool): void {.importc: "ImGuiMenuColumns_Update".}
...
proc isDataType*(self: ptr ImGuiPayload,
    `type`: cstring): bool {.importc: "ImGuiPayload_IsDataType".}
...
proc getBool*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: bool = false): bool {.importc: "ImGuiStorage_GetBool".}
proc getBoolRef*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: bool = false): ptr bool {.importc: "ImGuiStorage_GetBoolRef".}
proc getFloat*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: float32 = 0.0f): float32 {.importc: "ImGuiStorage_GetFloat".}
proc getFloatRef*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: float32 = 0.0f): ptr float32 {.importc: "ImGuiStorage_GetFloatRef".}
proc getInt*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: int32 = 0): int32 {.importc: "ImGuiStorage_GetInt".}
proc getIntRef*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: int32 = 0): ptr int32 {.importc: "ImGuiStorage_GetIntRef".}
proc getVoidPtr*(self: ptr ImGuiStorage,
    key: ImGuiID): pointer {.importc: "ImGuiStorage_GetVoidPtr".}
proc getVoidPtrRef*(self: ptr ImGuiStorage, key: ImGuiID,
    default_val: pointer = nil): ptr pointer {.importc: "ImGuiStorage_GetVoidPtrRef".}
proc setAllInt*(self: ptr ImGuiStorage, val: int32): void {.importc: "ImGuiStorage_SetAllInt".}
proc setBool*(self: ptr ImGuiStorage, key: ImGuiID,
    val: bool): void {.importc: "ImGuiStorage_SetBool".}
proc setFloat*(self: ptr ImGuiStorage, key: ImGuiID,
    val: float32): void {.importc: "ImGuiStorage_SetFloat".}
proc setInt*(self: ptr ImGuiStorage, key: ImGuiID,
    val: int32): void {.importc: "ImGuiStorage_SetInt".}
proc setVoidPtr*(self: ptr ImGuiStorage, key: ImGuiID,
    val: pointer): void {.importc: "ImGuiStorage_SetVoidPtr".}
proc newImGuiStyleMod*(idx: ImGuiStyleVar,
    v: int32): void {.importc: "ImGuiStyleMod_ImGuiStyleMod_Int".}
proc newImGuiStyleMod*(idx: ImGuiStyleVar,
    v: float32): void {.importc: "ImGuiStyleMod_ImGuiStyleMod_Float".}
proc newImGuiStyleMod*(idx: ImGuiStyleVar,
    v: ImVec2): void {.importc: "ImGuiStyleMod_ImGuiStyleMod_Vec2".}
...
proc scaleAllSizes*(self: ptr ImGuiStyle,
    scale_factor: float32): void {.importc: "ImGuiStyle_ScaleAllSizes".}
...
proc getTabOrder*(self: ptr ImGuiTabBar,
...
proc append*(self: ptr ImGuiTextBuffer, str: cstring,
    str_end: cstring = nil): void {.importc: "ImGuiTextBuffer_append".}
proc appendf*(self: ptr ImGuiTextBuffer,
    fmt: cstring): void {.importc: "ImGuiTextBuffer_appendf", varargs.}
proc appendfv*(self: ptr ImGuiTextBuffer,
    fmt: cstring): void {.importc: "ImGuiTextBuffer_appendfv", varargs.}
...
proc reserve*(self: ptr ImGuiTextBuffer,
    capacity: int32): void {.importc: "ImGuiTextBuffer_reserve".}
...
proc draw*(self: ptr ImGuiTextFilter, label: cstring = "Filter(inc,-exc)",
    width: float32 = 0.0f): bool {.importc: "ImGuiTextFilter_Draw".}
...
proc passFilter*(self: ptr ImGuiTextFilter, text: cstring,
    text_end: cstring = nil): bool {.importc: "ImGuiTextFilter_PassFilter".}
...
proc split*(self: ptr ImGuiTextRange, separator: int8, `out`: ptr ImVector[
    ImGuiTextRange]): void {.importc: "ImGuiTextRange_split".}
proc calcWorkRectPosNonUDT*(pOut: ptr ImVec2, self: ptr ImGuiViewportP,
    off_min: ImVec2): void {.importc: "ImGuiViewportP_CalcWorkRectPos".}
proc calcWorkRectSizeNonUDT*(pOut: ptr ImVec2, self: ptr ImGuiViewportP,
    off_min: ImVec2,
    off_max: ImVec2): void {.importc: "ImGuiViewportP_CalcWorkRectSize".}
proc getBuildWorkRectNonUDT*(pOut: ptr ImRect,
    self: ptr ImGuiViewportP): void {.importc: "ImGuiViewportP_GetBuildWorkRect".}
proc getMainRectNonUDT*(pOut: ptr ImRect,
    self: ptr ImGuiViewportP): void {.importc: "ImGuiViewportP_GetMainRect".}
proc getWorkRectNonUDT*(pOut: ptr ImRect,
    self: ptr ImGuiViewportP): void {.importc: "ImGuiViewportP_GetWorkRect".}
...
proc getWorkCenterNonUDT*(pOut: ptr ImVec2,
    self: ptr ImGuiViewport): void {.importc: "ImGuiViewport_GetWorkCenter".}
...
proc getID*(self: ptr ImGuiWindow, str: cstring,
    str_end: cstring = nil): ImGuiID {.importc: "ImGuiWindow_GetID_Str".}
...
proc getIDFromRectangle*(self: ptr ImGuiWindow,
    r_abs: ImRect): ImGuiID {.importc: "ImGuiWindow_GetIDFromRectangle".}
proc getIDNoKeepAlive*(self: ptr ImGuiWindow, str: cstring,
    str_end: cstring = nil): ImGuiID {.importc: "ImGuiWindow_GetIDNoKeepAlive_Str".}
proc getIDNoKeepAlive*(self: ptr ImGuiWindow,
    `ptr`: pointer): ImGuiID {.importc: "ImGuiWindow_GetIDNoKeepAlive_Ptr".}
proc getIDNoKeepAlive*(self: ptr ImGuiWindow,
    n: int32): ImGuiID {.importc: "ImGuiWindow_GetIDNoKeepAlive_Int".}
proc newImGuiWindow*(context: ptr ImGuiContext,
    name: cstring): void {.importc: "ImGuiWindow_ImGuiWindow".}
proc menuBarHeight*(self: ptr ImGuiWindow): float32 {.importc: "ImGuiWindow_MenuBarHeight".}
proc menuBarRectNonUDT*(pOut: ptr ImRect,
    self: ptr ImGuiWindow): void {.importc: "ImGuiWindow_MenuBarRect".}
...
proc titleBarRectNonUDT*(pOut: ptr ImRect,
    self: ptr ImGuiWindow): void {.importc: "ImGuiWindow_TitleBarRect".}
...
proc getOrAddByKey*[T](self: ptr ImPool,
    key: ImGuiID): ptr T {.importc: "ImPool_GetOrAddByKey".}
proc newImPool*(): void {.importc: "ImPool_ImPool".}
proc remove*[T](self: ptr ImPool, key: ImGuiID,
    p: ptr T): void {.importc: "ImPool_Remove_TPtr".}
proc remove*(self: ptr ImPool, key: ImGuiID,
    idx: ImPoolIdx): void {.importc: "ImPool_Remove_PoolIdx".}
proc reserve*(self: ptr ImPool, capacity: int32): void {.importc: "ImPool_Reserve".}
proc tryGetMapData*[T](self: ptr ImPool,
    n: ImPoolIdx): ptr T {.importc: "ImPool_TryGetMapData".}
...
proc newImRect*(x1: float32, y1: float32, x2: float32,
    y2: float32): void {.importc: "ImRect_ImRect_Float".}
...
proc getSpanPtrBegin*(self: ptr ImSpanAllocator,
    n: int32): pointer {.importc: "ImSpanAllocator_GetSpanPtrBegin".}
proc getSpanPtrEnd*(self: ptr ImSpanAllocator,
    n: int32): pointer {.importc: "ImSpanAllocator_GetSpanPtrEnd".}
proc newImSpanAllocator*(): void {.importc: "ImSpanAllocator_ImSpanAllocator".}
proc reserve*(self: ptr ImSpanAllocator, n: int32, sz: uint,
    a: int32 = 4): void {.importc: "ImSpanAllocator_Reserve".}
proc setArenaBasePtr*(self: ptr ImSpanAllocator,
    base_ptr: pointer): void {.importc: "ImSpanAllocator_SetArenaBasePtr".}
...
proc index_from_ptr*[T](self: ptr ImSpan,
    it: ptr T): int32 {.importc: "ImSpan_index_from_ptr".}
proc set*[T](self: ptr ImSpan, data: ptr T,
    size: int32): void {.importc: "ImSpan_set_Int".}
proc set*[T](self: ptr ImSpan, data: ptr T,
    data_end: ptr T): void {.importc: "ImSpan_set_TPtr".}
...
proc newImVec4*(x: float32, y: float32, z: float32,
    w: float32): void {.importc: "ImVec4_ImVec4_Float".}
...
proc erase*[T](self: ptr ImVector, it: ptr T,
    it_last: ptr T): ptr T {.importc: "ImVector_erase_TPtr".}
proc erase_unsorted*[T](self: ptr ImVector,
    it: ptr T): ptr T {.importc: "ImVector_erase_unsorted".}
...
proc find_erase_unsorted*[T](self: ptr ImVector,
    v: T): bool {.importc: "ImVector_find_erase_unsorted".}
proc front*[T](self: ptr ImVector): ptr T {.importc: "ImVector_front_Nil".}
proc index_from_ptr*[T](self: ptr ImVector,
    it: ptr T): int32 {.importc: "ImVector_index_from_ptr".}
proc insert*[T](self: ptr ImVector, it: ptr T,
    v: T): ptr T {.importc: "ImVector_insert".}
...
proc resize*[T](self: ptr ImVector, new_size: int32,
    v: T): void {.importc: "ImVector_resize_T".}
...
proc igAcceptDragDropPayload*(`type`: cstring,
    flags: ImGuiDragDropFlags = 0.ImGuiDragDropFlags): ptr ImGuiPayload {.importc: "igAcceptDragDropPayload".}
proc igActivateItem*(id: ImGuiID): void {.importc: "igActivateItem".}
proc igAddContextHook*(context: ptr ImGuiContext,
    hook: ptr ImGuiContextHook): ImGuiID {.importc: "igAddContextHook".}
...
proc igArrowButtonEx*(str_id: cstring, dir: ImGuiDir, size_arg: ImVec2,
    flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool {.importc: "igArrowButtonEx".}
proc igBegin*(name: cstring, p_open: ptr bool = nil,
    flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.importc: "igBegin".}
proc igBeginChild*(str_id: cstring, size: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    border: bool = false,
    flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.importc: "igBeginChild_Str".}
proc igBeginChild*(id: ImGuiID, size: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    border: bool = false,
    flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.importc: "igBeginChild_ID".}
...
proc igBeginChildFrame*(id: ImGuiID, size: ImVec2,
    flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.importc: "igBeginChildFrame".}
proc igBeginColumns*(str_id: cstring, count: int32,
    flags: ImGuiOldColumnFlags = 0.ImGuiOldColumnFlags): void {.importc: "igBeginColumns".}
proc igBeginCombo*(label: cstring, preview_value: cstring,
    flags: ImGuiComboFlags = 0.ImGuiComboFlags): bool {.importc: "igBeginCombo".}
proc igBeginComboPopup*(popup_id: ImGuiID, bb: ImRect,
    flags: ImGuiComboFlags): bool {.importc: "igBeginComboPopup".}
...
proc igBeginDragDropTargetCustom*(bb: ImRect,
    id: ImGuiID): bool {.importc: "igBeginDragDropTargetCustom".}
proc igBeginGroup*(): void {.importc: "igBeginGroup".}
proc igBeginListBox*(label: cstring, size: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): bool {.importc: "igBeginListBox".}
...
proc igBeginPopupContextItem*(str_id: cstring = nil,
    popup_flags: ImGuiPopupFlags = 1.ImGuiPopupFlags): bool {.importc: "igBeginPopupContextItem".}
proc igBeginPopupContextVoid*(str_id: cstring = nil,
    popup_flags: ImGuiPopupFlags = 1.ImGuiPopupFlags): bool {.importc: "igBeginPopupContextVoid".}
proc igBeginPopupContextWindow*(str_id: cstring = nil,
    popup_flags: ImGuiPopupFlags = 1.ImGuiPopupFlags): bool {.importc: "igBeginPopupContextWindow".}
...
proc igBeginPopupModal*(name: cstring, p_open: ptr bool = nil,
    flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool {.importc: "igBeginPopupModal".}
...
proc igBeginTabBarEx*(tab_bar: ptr ImGuiTabBar, bb: ImRect,
    flags: ImGuiTabBarFlags): bool {.importc: "igBeginTabBarEx".}
proc igBeginTabItem*(label: cstring, p_open: ptr bool = nil,
    flags: ImGuiTabItemFlags = 0.ImGuiTabItemFlags): bool {.importc: "igBeginTabItem".}
proc igBeginTable*(str_id: cstring, column: int32,
    flags: ImGuiTableFlags = 0.ImGuiTableFlags, outer_size: ImVec2 = ImVec2(
    x: 0.0f, y: 0.0f).ImVec2,
    inner_width: float32 = 0.0f): bool {.importc: "igBeginTable".}
proc igBeginTableEx*(name: cstring, id: ImGuiID, columns_count: int32,
    flags: ImGuiTableFlags = 0.ImGuiTableFlags, outer_size: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2,
    inner_width: float32 = 0.0f): bool {.importc: "igBeginTableEx".}
proc igBeginTooltip*(): void {.importc: "igBeginTooltip".}
proc igBeginTooltipEx*(extra_flags: ImGuiWindowFlags,
    tooltip_flags: ImGuiTooltipFlags): void {.importc: "igBeginTooltipEx".}
proc igBeginViewportSideBar*(name: cstring, viewport: ptr ImGuiViewport,
    dir: ImGuiDir, size: float32,
    window_flags: ImGuiWindowFlags): bool {.importc: "igBeginViewportSideBar".}
...
proc igButton*(label: cstring, size: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): bool {.importc: "igButton".}
proc igButtonBehavior*(bb: ImRect, id: ImGuiID, out_hovered: ptr bool,
    out_held: ptr bool,
    flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool {.importc: "igButtonBehavior".}
proc igButtonEx*(label: cstring, size_arg: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool {.importc: "igButtonEx".}
...
proc igCalcListClipping*(items_count: int32, items_height: float32,
    ...
    out_items_display_end: ptr int32): void {.importc: "igCalcListClipping".}
proc igCalcTextSizeNonUDT*(pOut: ptr ImVec2, text: cstring,
    text_end: cstring = nil, hide_text_after_double_hash: bool = false,
    wrap_width: float32 = -1.0f): void {.importc: "igCalcTextSize".}
proc igCalcTypematicRepeatAmount*(t0: float32, t1: float32,
    repeat_delay: float32,
    repeat_rate: float32): int32 {.importc: "igCalcTypematicRepeatAmount".}
proc igCalcWindowNextAutoFitSizeNonUDT*(pOut: ptr ImVec2,
    window: ptr ImGuiWindow): void {.importc: "igCalcWindowNextAutoFitSize".}
proc igCalcWrapWidthForPos*(pos: ImVec2,
    wrap_pos_x: float32): float32 {.importc: "igCalcWrapWidthForPos".}
proc igCallContextHooks*(context: ptr ImGuiContext,
    `type`: ImGuiContextHookType): void {.importc: "igCallContextHooks".}
...
proc igCheckboxFlags*(label: cstring, flags: ptr int32,
    flags_value: int32): bool {.importc: "igCheckboxFlags_IntPtr".}
proc igCheckboxFlags*(label: cstring, flags: ptr uint32,
    flags_value: uint32): bool {.importc: "igCheckboxFlags_UintPtr".}
proc igCheckboxFlags*(label: cstring, flags: ptr int64,
    flags_value: int64): bool {.importc: "igCheckboxFlags_S64Ptr".}
proc igCheckboxFlags*(label: cstring, flags: ptr uint64,
    flags_value: uint64): bool {.importc: "igCheckboxFlags_U64Ptr".}
...
proc igClosePopupToLevel*(remaining: int32,
    restore_focus_to_window_under_popup: bool): void {.importc: "igClosePopupToLevel".}
proc igClosePopupsOverWindow*(ref_window: ptr ImGuiWindow,
    restore_focus_to_window_under_popup: bool): void {.importc: "igClosePopupsOverWindow".}
proc igCollapseButton*(id: ImGuiID, pos: ImVec2): bool {.importc: "igCollapseButton".}
proc igCollapsingHeader*(label: cstring,
    flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.importc: "igCollapsingHeader_TreeNodeFlags".}
proc igCollapsingHeader*(label: cstring, p_visible: ptr bool,
    flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.importc: "igCollapsingHeader_BoolPtr".}
proc igColorButton*(desc_id: cstring, col: ImVec4,
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags, size: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2): bool {.importc: "igColorButton".}
...
proc igColorConvertHSVtoRGB*(h: float32, s: float32, v: float32,
    ...
    out_b: ptr float32): void {.importc: "igColorConvertHSVtoRGB".}
proc igColorConvertRGBtoHSV*(r: float32, g: float32, b: float32,
    out_h: ptr float32, out_s: ptr float32,
    out_v: ptr float32): void {.importc: "igColorConvertRGBtoHSV".}
proc igColorConvertU32ToFloat4NonUDT*(pOut: ptr ImVec4,
    `in`: uint32): void {.importc: "igColorConvertU32ToFloat4".}
proc igColorEdit3*(label: cstring, col: var array[3, float32],
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool {.importc: "igColorEdit3".}
proc igColorEdit4*(label: cstring, col: var array[4, float32],
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool {.importc: "igColorEdit4".}
proc igColorEditOptionsPopup*(col: ptr float32,
    flags: ImGuiColorEditFlags): void {.importc: "igColorEditOptionsPopup".}
proc igColorPicker3*(label: cstring, col: var array[3, float32],
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool {.importc: "igColorPicker3".}
proc igColorPicker4*(label: cstring, col: var array[4, float32],
    flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags,
    ref_col: ptr float32 = nil): bool {.importc: "igColorPicker4".}
proc igColorPickerOptionsPopup*(ref_col: ptr float32,
    flags: ImGuiColorEditFlags): void {.importc: "igColorPickerOptionsPopup".}
proc igColorTooltip*(text: cstring, col: ptr float32,
    flags: ImGuiColorEditFlags): void {.importc: "igColorTooltip".}
proc igColumns*(count: int32 = 1, id: cstring = nil,
    border: bool = true): void {.importc: "igColumns".}
proc igCombo*(label: cstring, current_item: ptr int32, items: ptr cstring,
    items_count: int32,
    popup_max_height_in_items: int32 = -1): bool {.importc: "igCombo_Str_arr".}
proc igCombo*(label: cstring, current_item: ptr int32,
    items_separated_by_zeros: cstring,
    popup_max_height_in_items: int32 = -1): bool {.importc: "igCombo_Str".}
proc igCombo*(label: cstring, current_item: ptr int32, items_getter: proc(
    ...
    popup_max_height_in_items: int32 = -1): bool {.importc: "igCombo_FnBoolPtr".}
...
proc igDataTypeApplyOp*(data_type: ImGuiDataType, op: int32, output: pointer,
    arg_1: pointer, arg_2: pointer): void {.importc: "igDataTypeApplyOp".}
proc igDataTypeApplyOpFromText*(buf: cstring, initial_value_buf: cstring,
    data_type: ImGuiDataType, p_data: pointer,
    format: cstring): bool {.importc: "igDataTypeApplyOpFromText".}
proc igDataTypeClamp*(data_type: ImGuiDataType, p_data: pointer, p_min: pointer,
    p_max: pointer): bool {.importc: "igDataTypeClamp".}
proc igDataTypeCompare*(data_type: ImGuiDataType, arg_1: pointer,
    arg_2: pointer): int32 {.importc: "igDataTypeCompare".}
proc igDataTypeFormatString*(buf: cstring, buf_size: int32,
    data_type: ImGuiDataType, p_data: pointer,
    format: cstring): int32 {.importc: "igDataTypeFormatString".}
...
proc igDebugCheckVersionAndDataLayout*(version_str: cstring, sz_io: uint,
    sz_style: uint, sz_vec2: uint, sz_vec4: uint, sz_drawvert: uint,
    sz_drawidx: uint): bool {.importc: "igDebugCheckVersionAndDataLayout".}
...
proc igDebugNodeStorage*(storage: ptr ImGuiStorage,
    label: cstring): void {.importc: "igDebugNodeStorage".}
proc igDebugNodeTabBar*(tab_bar: ptr ImGuiTabBar,
    label: cstring): void {.importc: "igDebugNodeTabBar".}
...
proc igDebugNodeWindow*(window: ptr ImGuiWindow,
    label: cstring): void {.importc: "igDebugNodeWindow".}
...
proc igDebugNodeWindowsList*(windows: ptr ImVector[ptr ImGuiWindow],
    label: cstring): void {.importc: "igDebugNodeWindowsList".}
proc igDebugRenderViewportThumbnail*(draw_list: ptr ImDrawList,
    viewport: ptr ImGuiViewportP,
    bb: ImRect): void {.importc: "igDebugRenderViewportThumbnail".}
...
proc igDragBehavior*(id: ImGuiID, data_type: ImGuiDataType, p_v: pointer,
    v_speed: float32, p_min: pointer, p_max: pointer, format: cstring,
    flags: ImGuiSliderFlags): bool {.importc: "igDragBehavior".}
proc igDragFloat*(label: cstring, v: ptr float32, v_speed: float32 = 1.0f,
    v_min: float32 = 0.0f, v_max: float32 = 0.0f, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragFloat".}
proc igDragFloat2*(label: cstring, v: var array[2, float32],
    v_speed: float32 = 1.0f, v_min: float32 = 0.0f, v_max: float32 = 0.0f,
    format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragFloat2".}
proc igDragFloat3*(label: cstring, v: var array[3, float32],
    v_speed: float32 = 1.0f, v_min: float32 = 0.0f, v_max: float32 = 0.0f,
    format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragFloat3".}
proc igDragFloat4*(label: cstring, v: var array[4, float32],
    v_speed: float32 = 1.0f, v_min: float32 = 0.0f, v_max: float32 = 0.0f,
    format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragFloat4".}
proc igDragFloatRange2*(label: cstring, v_current_min: ptr float32,
    v_current_max: ptr float32, v_speed: float32 = 1.0f, v_min: float32 = 0.0f,
    v_max: float32 = 0.0f, format: cstring = "%.3f", format_max: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragFloatRange2".}
proc igDragInt*(label: cstring, v: ptr int32, v_speed: float32 = 1.0f,
    v_min: int32 = 0, v_max: int32 = 0, format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragInt".}
proc igDragInt2*(label: cstring, v: var array[2, int32],
    v_speed: float32 = 1.0f, v_min: int32 = 0, v_max: int32 = 0,
    format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragInt2".}
proc igDragInt3*(label: cstring, v: var array[3, int32],
    v_speed: float32 = 1.0f, v_min: int32 = 0, v_max: int32 = 0,
    format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragInt3".}
proc igDragInt4*(label: cstring, v: var array[4, int32],
    v_speed: float32 = 1.0f, v_min: int32 = 0, v_max: int32 = 0,
    format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragInt4".}
proc igDragIntRange2*(label: cstring, v_current_min: ptr int32,
    v_current_max: ptr int32, v_speed: float32 = 1.0f, v_min: int32 = 0,
    v_max: int32 = 0, format: cstring = "%d", format_max: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragIntRange2".}
proc igDragScalar*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    v_speed: float32 = 1.0f, p_min: pointer = nil, p_max: pointer = nil,
    format: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragScalar".}
proc igDragScalarN*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    components: int32, v_speed: float32 = 1.0f, p_min: pointer = nil,
    p_max: pointer = nil, format: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igDragScalarN".}
...
proc igErrorCheckEndFrameRecover*(log_callback: ImGuiErrorLogCallback,
    user_data: pointer = nil): void {.importc: "igErrorCheckEndFrameRecover".}
proc igFindBestWindowPosForPopupNonUDT*(pOut: ptr ImVec2,
    window: ptr ImGuiWindow): void {.importc: "igFindBestWindowPosForPopup".}
proc igFindBestWindowPosForPopupExNonUDT*(pOut: ptr ImVec2, ref_pos: ImVec2,
    ...
    policy: ImGuiPopupPositionPolicy): void {.importc: "igFindBestWindowPosForPopupEx".}
proc igFindOrCreateColumns*(window: ptr ImGuiWindow,
    id: ImGuiID): ptr ImGuiOldColumns {.importc: "igFindOrCreateColumns".}
proc igFindOrCreateWindowSettings*(name: cstring): ptr ImGuiWindowSettings {.importc: "igFindOrCreateWindowSettings".}
proc igFindRenderedTextEnd*(text: cstring,
    text_end: cstring = nil): cstring {.importc: "igFindRenderedTextEnd".}
...
proc igFocusTopMostWindowUnderOne*(under_this_window: ptr ImGuiWindow,
    ignore_window: ptr ImGuiWindow): void {.importc: "igFocusTopMostWindowUnderOne".}
...
proc igGcCompactTransientWindowBuffers*(
  window: ptr ImGuiWindow): void {.importc: "igGcCompactTransientWindowBuffers".}
proc igGetActiveID*(): ImGuiID {.importc: "igGetActiveID".}
proc igGetAllocatorFunctions*(p_alloc_func: ptr ImGuiMemAllocFunc,
    p_free_func: ptr ImGuiMemFreeFunc,
    p_user_data: ptr pointer): void {.importc: "igGetAllocatorFunctions".}
...
proc igGetColumnNormFromOffset*(columns: ptr ImGuiOldColumns,
    offset: float32): float32 {.importc: "igGetColumnNormFromOffset".}
...
proc igGetColumnOffsetFromNorm*(columns: ptr ImGuiOldColumns,
    offset_norm: float32): float32 {.importc: "igGetColumnOffsetFromNorm".}
...
proc igGetIDWithSeed*(str_id_begin: cstring, str_id_end: cstring,
    seed: ImGuiID): ImGuiID {.importc: "igGetIDWithSeed".}
...
proc igGetKeyPressedAmount*(key_index: int32, repeat_delay: float32,
    rate: float32): int32 {.importc: "igGetKeyPressedAmount".}
...
proc igGetMouseDragDeltaNonUDT*(pOut: ptr ImVec2,
    ...
    lock_threshold: float32 = -1.0f): void {.importc: "igGetMouseDragDelta".}
proc igGetMousePosNonUDT*(pOut: ptr ImVec2): void {.importc: "igGetMousePos".}
proc igGetMousePosOnOpeningCurrentPopupNonUDT*(
  pOut: ptr ImVec2): void {.importc: "igGetMousePosOnOpeningCurrentPopup".}
proc igGetNavInputAmount*(n: ImGuiNavInput,
    mode: ImGuiInputReadMode): float32 {.importc: "igGetNavInputAmount".}
proc igGetNavInputAmount2dNonUDT*(pOut: ptr ImVec2,
    dir_sources: ImGuiNavDirSourceFlags, mode: ImGuiInputReadMode,
    slow_factor: float32 = 0.0f,
    fast_factor: float32 = 0.0f): void {.importc: "igGetNavInputAmount2d".}
proc igGetPopupAllowedExtentRectNonUDT*(pOut: ptr ImRect,
    window: ptr ImGuiWindow): void {.importc: "igGetPopupAllowedExtentRect".}
...
proc igGetWindowContentRegionMaxNonUDT*(
  pOut: ptr ImVec2): void {.importc: "igGetWindowContentRegionMax".}
proc igGetWindowContentRegionMinNonUDT*(
  pOut: ptr ImVec2): void {.importc: "igGetWindowContentRegionMin".}
...
proc igGetWindowResizeBorderID*(window: ptr ImGuiWindow,
    dir: ImGuiDir): ImGuiID {.importc: "igGetWindowResizeBorderID".}
proc igGetWindowResizeCornerID*(window: ptr ImGuiWindow,
    n: int32): ImGuiID {.importc: "igGetWindowResizeCornerID".}
proc igGetWindowScrollbarID*(window: ptr ImGuiWindow,
    axis: ImGuiAxis): ImGuiID {.importc: "igGetWindowScrollbarID".}
proc igGetWindowScrollbarRectNonUDT*(pOut: ptr ImRect, window: ptr ImGuiWindow,
    axis: ImGuiAxis): void {.importc: "igGetWindowScrollbarRect".}
...
proc igImAlphaBlendColors*(col_a: uint32,
    col_b: uint32): uint32 {.importc: "igImAlphaBlendColors".}
proc igImBezierCubicCalcNonUDT*(pOut: ptr ImVec2, p1: ImVec2, p2: ImVec2,
    p3: ImVec2, p4: ImVec2, t: float32): void {.importc: "igImBezierCubicCalc".}
proc igImBezierCubicClosestPointNonUDT*(pOut: ptr ImVec2, p1: ImVec2,
    p2: ImVec2, p3: ImVec2, p4: ImVec2, p: ImVec2,
    num_segments: int32): void {.importc: "igImBezierCubicClosestPoint".}
proc igImBezierCubicClosestPointCasteljauNonUDT*(pOut: ptr ImVec2, p1: ImVec2,
    p2: ImVec2, p3: ImVec2, p4: ImVec2, p: ImVec2,
    tess_tol: float32): void {.importc: "igImBezierCubicClosestPointCasteljau".}
proc igImBezierQuadraticCalcNonUDT*(pOut: ptr ImVec2, p1: ImVec2, p2: ImVec2,
    p3: ImVec2, t: float32): void {.importc: "igImBezierQuadraticCalc".}
proc igImBitArrayClearBit*(arr: ptr uint32,
    n: int32): void {.importc: "igImBitArrayClearBit".}
proc igImBitArraySetBit*(arr: ptr uint32,
    n: int32): void {.importc: "igImBitArraySetBit".}
proc igImBitArraySetBitRange*(arr: ptr uint32, n: int32,
    n2: int32): void {.importc: "igImBitArraySetBitRange".}
proc igImBitArrayTestBit*(arr: ptr uint32,
    n: int32): bool {.importc: "igImBitArrayTestBit".}
proc igImCharIsBlankA*(c: int8): bool {.importc: "igImCharIsBlankA".}
proc igImCharIsBlankW*(c: uint32): bool {.importc: "igImCharIsBlankW".}
proc igImClampNonUDT*(pOut: ptr ImVec2, v: ImVec2, mn: ImVec2,
    mx: ImVec2): void {.importc: "igImClamp".}
...
proc igImFileLoadToMemory*(filename: cstring, mode: cstring,
    ...
    padding_bytes: int32 = 0): pointer {.importc: "igImFileLoadToMemory".}
proc igImFileOpen*(filename: cstring, mode: cstring): ImFileHandle {.importc: "igImFileOpen".}
proc igImFileRead*(data: pointer, size: uint64, count: uint64,
    file: ImFileHandle): uint64 {.importc: "igImFileRead".}
...
proc igImFontAtlasBuildPackCustomRects*(atlas: ptr ImFontAtlas,
    stbrp_context_opaque: pointer): void {.importc: "igImFontAtlasBuildPackCustomRects".}
proc igImFontAtlasBuildRender32bppRectFromString*(atlas: ptr ImFontAtlas,
    x: int32, y: int32, w: int32, h: int32, in_str: cstring,
    in_marker_char: int8,
    in_marker_pixel_value: uint32): void {.importc: "igImFontAtlasBuildRender32bppRectFromString".}
...
proc igImFormatString*(buf: cstring, buf_size: uint,
    fmt: cstring): int32 {.importc: "igImFormatString", varargs.}
proc igImFormatStringV*(buf: cstring, buf_size: uint,
    fmt: cstring): int32 {.importc: "igImFormatStringV", varargs.}
proc igImGetDirQuadrantFromDelta*(dx: float32,
    dy: float32): ImGuiDir {.importc: "igImGetDirQuadrantFromDelta".}
proc igImHashData*(data: pointer, data_size: uint,
    seed: uint32 = 0): ImGuiID {.importc: "igImHashData".}
proc igImHashStr*(data: cstring, data_size: uint = 0,
    seed: uint32 = 0): ImGuiID {.importc: "igImHashStr".}
...
proc igImLerpNonUDT*(pOut: ptr ImVec2, a: ImVec2, b: ImVec2,
    t: float32): void {.importc: "igImLerp_Vec2Float".}
proc igImLerpNonUDT2*(pOut: ptr ImVec2, a: ImVec2, b: ImVec2,
    t: ImVec2): void {.importc: "igImLerp_Vec2Vec2".}
proc igImLerpNonUDT3*(pOut: ptr ImVec4, a: ImVec4, b: ImVec4,
    t: float32): void {.importc: "igImLerp_Vec4".}
proc igImLineClosestPointNonUDT*(pOut: ptr ImVec2, a: ImVec2, b: ImVec2,
    p: ImVec2): void {.importc: "igImLineClosestPoint".}
proc igImLinearSweep*(current: float32, target: float32,
    speed: float32): float32 {.importc: "igImLinearSweep".}
proc igImLog*(x: float32): float32 {.importc: "igImLog_Float".}
proc igImLog*(x: float64): float64 {.importc: "igImLog_double".}
proc igImMaxNonUDT*(pOut: ptr ImVec2, lhs: ImVec2,
    rhs: ImVec2): void {.importc: "igImMax".}
proc igImMinNonUDT*(pOut: ptr ImVec2, lhs: ImVec2,
    rhs: ImVec2): void {.importc: "igImMin".}
proc igImModPositive*(a: int32, b: int32): int32 {.importc: "igImModPositive".}
proc igImMulNonUDT*(pOut: ptr ImVec2, lhs: ImVec2,
    rhs: ImVec2): void {.importc: "igImMul".}
...
proc igImParseFormatPrecision*(format: cstring,
    default_value: int32): int32 {.importc: "igImParseFormatPrecision".}
proc igImParseFormatTrimDecorations*(format: cstring, buf: cstring,
    buf_size: uint): cstring {.importc: "igImParseFormatTrimDecorations".}
...
proc igImRotateNonUDT*(pOut: ptr ImVec2, v: ImVec2, cos_a: float32,
    sin_a: float32): void {.importc: "igImRotate".}
...
proc igImStrbolW*(buf_mid_line: ptr ImWchar,
    buf_begin: ptr ImWchar): ptr ImWchar {.importc: "igImStrbolW".}
proc igImStrchrRange*(str_begin: cstring, str_end: cstring,
    c: int8): cstring {.importc: "igImStrchrRange".}
proc igImStrdup*(str: cstring): cstring {.importc: "igImStrdup".}
proc igImStrdupcpy*(dst: cstring, p_dst_size: ptr uint,
    str: cstring): cstring {.importc: "igImStrdupcpy".}
...
proc igImStristr*(haystack: cstring, haystack_end: cstring, needle: cstring,
    needle_end: cstring): cstring {.importc: "igImStristr".}
proc igImStrlenW*(str: ptr ImWchar): int32 {.importc: "igImStrlenW".}
proc igImStrncpy*(dst: cstring, src: cstring,
    count: uint): void {.importc: "igImStrncpy".}
proc igImStrnicmp*(str1: cstring, str2: cstring,
    count: uint): int32 {.importc: "igImStrnicmp".}
proc igImTextCharFromUtf8*(out_char: ptr uint32, in_text: cstring,
    in_text_end: cstring): int32 {.importc: "igImTextCharFromUtf8".}
proc igImTextCharToUtf8*(out_buf: var array[5, int8],
    c: uint32): cstring {.importc: "igImTextCharToUtf8".}
proc igImTextCountCharsFromUtf8*(in_text: cstring,
    in_text_end: cstring): int32 {.importc: "igImTextCountCharsFromUtf8".}
proc igImTextCountUtf8BytesFromChar*(in_text: cstring,
    in_text_end: cstring): int32 {.importc: "igImTextCountUtf8BytesFromChar".}
proc igImTextCountUtf8BytesFromStr*(in_text: ptr ImWchar,
    in_text_end: ptr ImWchar): int32 {.importc: "igImTextCountUtf8BytesFromStr".}
proc igImTextStrFromUtf8*(out_buf: ptr ImWchar, out_buf_size: int32,
    in_text: cstring, in_text_end: cstring,
    in_remaining: ptr cstring = nil): int32 {.importc: "igImTextStrFromUtf8".}
proc igImTextStrToUtf8*(out_buf: cstring, out_buf_size: int32,
    in_text: ptr ImWchar,
    in_text_end: ptr ImWchar): int32 {.importc: "igImTextStrToUtf8".}
proc igImTriangleArea*(a: ImVec2, b: ImVec2,
    c: ImVec2): float32 {.importc: "igImTriangleArea".}
proc igImTriangleBarycentricCoords*(a: ImVec2, b: ImVec2, c: ImVec2, p: ImVec2,
    out_u: ptr float32, out_v: ptr float32,
    out_w: ptr float32): void {.importc: "igImTriangleBarycentricCoords".}
proc igImTriangleClosestPointNonUDT*(pOut: ptr ImVec2, a: ImVec2, b: ImVec2,
    c: ImVec2, p: ImVec2): void {.importc: "igImTriangleClosestPoint".}
proc igImTriangleContainsPoint*(a: ImVec2, b: ImVec2, c: ImVec2,
    p: ImVec2): bool {.importc: "igImTriangleContainsPoint".}
proc igImUpperPowerOfTwo*(v: int32): int32 {.importc: "igImUpperPowerOfTwo".}
proc igImage*(user_texture_id: ImTextureID, size: ImVec2, uv0: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2, uv1: ImVec2 = ImVec2(x: 1, y: 1).ImVec2,
    tint_col: ImVec4 = ImVec4(x: 1, y: 1, z: 1, w: 1).ImVec4,
    border_col: ImVec4 = ImVec4(x: 0, y: 0, z: 0,
    w: 0).ImVec4): void {.importc: "igImage".}
proc igImageButton*(user_texture_id: ImTextureID, size: ImVec2,
    uv0: ImVec2 = ImVec2(x: 0, y: 0).ImVec2, uv1: ImVec2 = ImVec2(x: 1,
    y: 1).ImVec2, frame_padding: int32 = -1, bg_col: ImVec4 = ImVec4(x: 0, y: 0,
    z: 0, w: 0).ImVec4, tint_col: ImVec4 = ImVec4(x: 1, y: 1, z: 1,
    w: 1).ImVec4): bool {.importc: "igImageButton".}
...
proc igInputDouble*(label: cstring, v: ptr float64, step: float64 = 0.0,
    ...
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputDouble".}
proc igInputFloat*(label: cstring, v: ptr float32, step: float32 = 0.0f,
    step_fast: float32 = 0.0f, format: cstring = "%.3f",
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputFloat".}
proc igInputFloat2*(label: cstring, v: var array[2, float32],
    format: cstring = "%.3f",
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputFloat2".}
proc igInputFloat3*(label: cstring, v: var array[3, float32],
    format: cstring = "%.3f",
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputFloat3".}
proc igInputFloat4*(label: cstring, v: var array[4, float32],
    format: cstring = "%.3f",
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputFloat4".}
proc igInputInt*(label: cstring, v: ptr int32, step: int32 = 1,
    step_fast: int32 = 100,
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputInt".}
proc igInputInt2*(label: cstring, v: var array[2, int32],
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputInt2".}
proc igInputInt3*(label: cstring, v: var array[3, int32],
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputInt3".}
proc igInputInt4*(label: cstring, v: var array[4, int32],
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputInt4".}
proc igInputScalar*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    p_step: pointer = nil, p_step_fast: pointer = nil, format: cstring = nil,
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputScalar".}
proc igInputScalarN*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    components: int32, p_step: pointer = nil, p_step_fast: pointer = nil,
    format: cstring = nil,
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool {.importc: "igInputScalarN".}
...
proc igInputTextEx*(label: cstring, hint: cstring, buf: cstring,
    buf_size: int32, size_arg: ImVec2, flags: ImGuiInputTextFlags,
    callback: ImGuiInputTextCallback = nil,
    user_data: pointer = nil): bool {.importc: "igInputTextEx".}
proc igInputTextMultiline*(label: cstring, buf: cstring, buf_size: uint,
    size: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags,
    callback: ImGuiInputTextCallback = nil,
    user_data: pointer = nil): bool {.importc: "igInputTextMultiline".}
proc igInputTextWithHint*(label: cstring, hint: cstring, buf: cstring,
    buf_size: uint, flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags,
    callback: ImGuiInputTextCallback = nil,
    user_data: pointer = nil): bool {.importc: "igInputTextWithHint".}
proc igInvisibleButton*(str_id: cstring, size: ImVec2,
    flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool {.importc: "igInvisibleButton".}
...
proc igIsClippedEx*(bb: ImRect, id: ImGuiID,
    clip_even_when_logged: bool): bool {.importc: "igIsClippedEx".}
...
proc igIsKeyPressed*(user_key_index: int32,
    repeat: bool = true): bool {.importc: "igIsKeyPressed".}
...
proc igIsMouseClicked*(button: ImGuiMouseButton,
    repeat: bool = false): bool {.importc: "igIsMouseClicked".}
...
proc igIsMouseDragPastThreshold*(button: ImGuiMouseButton,
    lock_threshold: float32 = -1.0f): bool {.importc: "igIsMouseDragPastThreshold".}
proc igIsMouseDragging*(button: ImGuiMouseButton,
    lock_threshold: float32 = -1.0f): bool {.importc: "igIsMouseDragging".}
proc igIsMouseHoveringRect*(r_min: ImVec2, r_max: ImVec2,
    clip: bool = true): bool {.importc: "igIsMouseHoveringRect".}
...
proc igIsNavInputTest*(n: ImGuiNavInput,
    rm: ImGuiInputReadMode): bool {.importc: "igIsNavInputTest".}
...
proc igIsWindowAbove*(potential_above: ptr ImGuiWindow,
    potential_below: ptr ImGuiWindow): bool {.importc: "igIsWindowAbove".}
proc igIsWindowAppearing*(): bool {.importc: "igIsWindowAppearing".}
proc igIsWindowChildOf*(window: ptr ImGuiWindow,
    potential_parent: ptr ImGuiWindow): bool {.importc: "igIsWindowChildOf".}
...
proc igItemAdd*(bb: ImRect, id: ImGuiID, nav_bb: ptr ImRect = nil,
    flags: ImGuiItemAddFlags = 0.ImGuiItemAddFlags): bool {.importc: "igItemAdd".}
proc igItemFocusable*(window: ptr ImGuiWindow,
    id: ImGuiID): void {.importc: "igItemFocusable".}
...
proc igListBox*(label: cstring, current_item: ptr int32, items: ptr cstring,
    items_count: int32,
    height_in_items: int32 = -1): bool {.importc: "igListBox_Str_arr".}
proc igListBox*(label: cstring, current_item: ptr int32, items_getter: proc(
    data: pointer, idx: int32, out_text: ptr cstring): bool {.cdecl, varargs.},
    data: pointer, items_count: int32,
    height_in_items: int32 = -1): bool {.importc: "igListBox_FnBoolPtr".}
proc igLoadIniSettingsFromDisk*(ini_filename: cstring): void {.importc: "igLoadIniSettingsFromDisk".}
proc igLoadIniSettingsFromMemory*(ini_data: cstring,
    ini_size: uint = 0): void {.importc: "igLoadIniSettingsFromMemory".}
...
proc igLogRenderedText*(ref_pos: ptr ImVec2, text: cstring,
    text_end: cstring = nil): void {.importc: "igLogRenderedText".}
proc igLogSetNextTextDecoration*(prefix: cstring,
    suffix: cstring): void {.importc: "igLogSetNextTextDecoration".}
...
proc igLogToFile*(auto_open_depth: int32 = -1,
    filename: cstring = nil): void {.importc: "igLogToFile".}
...
proc igMenuItem*(label: cstring, shortcut: cstring = nil,
    selected: bool = false,
    enabled: bool = true): bool {.importc: "igMenuItem_Bool".}
proc igMenuItem*(label: cstring, shortcut: cstring, p_selected: ptr bool,
    enabled: bool = true): bool {.importc: "igMenuItem_BoolPtr".}
proc igMenuItemEx*(label: cstring, icon: cstring, shortcut: cstring = nil,
    selected: bool = false,
    enabled: bool = true): bool {.importc: "igMenuItemEx".}
proc igNavInitWindow*(window: ptr ImGuiWindow,
    force_reinit: bool): void {.importc: "igNavInitWindow".}
...
proc igNavMoveRequestForward*(move_dir: ImGuiDir, clip_dir: ImGuiDir,
    bb_rel: ImRect,
    move_flags: ImGuiNavMoveFlags): void {.importc: "igNavMoveRequestForward".}
proc igNavMoveRequestTryWrapping*(window: ptr ImGuiWindow,
    move_flags: ImGuiNavMoveFlags): void {.importc: "igNavMoveRequestTryWrapping".}
...
proc igOpenPopupOnItemClick*(str_id: cstring = nil,
    popup_flags: ImGuiPopupFlags = 1.ImGuiPopupFlags): void {.importc: "igOpenPopupOnItemClick".}
proc igPlotEx*(plot_type: ImGuiPlotType, label: cstring, values_getter: proc(
    ...
    scale_min: float32, scale_max: float32,
    frame_size: ImVec2): int32 {.importc: "igPlotEx".}
proc igPlotHistogram*(label: cstring, values: ptr float32, values_count: int32,
    ...
    graph_size: ImVec2 = ImVec2(x: 0, y: 0).ImVec2, stride: int32 = sizeof(
    float32).int32): void {.importc: "igPlotHistogram_FloatPtr".}
proc igPlotHistogram*(label: cstring, values_getter: proc(data: pointer,
    ...
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): void {.importc: "igPlotHistogram_FnFloatPtr".}
proc igPlotLines*(label: cstring, values: ptr float32, values_count: int32,
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0, y: 0).ImVec2, stride: int32 = sizeof(
    float32).int32): void {.importc: "igPlotLines_FloatPtr".}
proc igPlotLines*(label: cstring, values_getter: proc(data: pointer,
    idx: int32): float32 {.cdecl, varargs.}, data: pointer, values_count: int32,
    values_offset: int32 = 0, overlay_text: cstring = nil,
    scale_min: float32 = high(float32), scale_max: float32 = high(float32),
    graph_size: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): void {.importc: "igPlotLines_FnFloatPtr".}
...
proc igProgressBar*(fraction: float32, size_arg: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2, overlay: cstring = nil): void {.importc: "igProgressBar".}
...
proc igPushClipRect*(clip_rect_min: ImVec2, clip_rect_max: ImVec2,
    intersect_with_current_clip_rect: bool): void {.importc: "igPushClipRect".}
...
proc igPushItemFlag*(option: ImGuiItemFlags,
    enabled: bool): void {.importc: "igPushItemFlag".}
proc igPushItemWidth*(item_width: float32): void {.importc: "igPushItemWidth".}
proc igPushMultiItemsWidths*(components: int32,
    width_full: float32): void {.importc: "igPushMultiItemsWidths".}
...
proc igPushStyleVar*(idx: ImGuiStyleVar,
    val: float32): void {.importc: "igPushStyleVar_Float".}
proc igPushStyleVar*(idx: ImGuiStyleVar,
    val: ImVec2): void {.importc: "igPushStyleVar_Vec2".}
...
proc igRadioButton*(label: cstring, v: ptr int32,
    v_button: int32): bool {.importc: "igRadioButton_IntPtr".}
proc igRemoveContextHook*(context: ptr ImGuiContext,
    hook_to_remove: ImGuiID): void {.importc: "igRemoveContextHook".}
proc igRender*(): void {.importc: "igRender".}
proc igRenderArrow*(draw_list: ptr ImDrawList, pos: ImVec2, col: uint32,
    dir: ImGuiDir, scale: float32 = 1.0f): void {.importc: "igRenderArrow".}
proc igRenderArrowPointingAt*(draw_list: ptr ImDrawList, pos: ImVec2,
    half_sz: ImVec2, direction: ImGuiDir,
    col: uint32): void {.importc: "igRenderArrowPointingAt".}
proc igRenderBullet*(draw_list: ptr ImDrawList, pos: ImVec2,
    col: uint32): void {.importc: "igRenderBullet".}
proc igRenderCheckMark*(draw_list: ptr ImDrawList, pos: ImVec2, col: uint32,
    sz: float32): void {.importc: "igRenderCheckMark".}
proc igRenderColorRectWithAlphaCheckerboard*(draw_list: ptr ImDrawList,
    ...
    grid_off: ImVec2, rounding: float32 = 0.0f,
    flags: ImDrawFlags = 0.ImDrawFlags): void {.importc: "igRenderColorRectWithAlphaCheckerboard".}
proc igRenderFrame*(p_min: ImVec2, p_max: ImVec2, fill_col: uint32,
    border: bool = true,
    rounding: float32 = 0.0f): void {.importc: "igRenderFrame".}
proc igRenderFrameBorder*(p_min: ImVec2, p_max: ImVec2,
    rounding: float32 = 0.0f): void {.importc: "igRenderFrameBorder".}
proc igRenderMouseCursor*(draw_list: ptr ImDrawList, pos: ImVec2,
    scale: float32, mouse_cursor: ImGuiMouseCursor, col_fill: uint32,
    col_border: uint32,
    col_shadow: uint32): void {.importc: "igRenderMouseCursor".}
proc igRenderNavHighlight*(bb: ImRect, id: ImGuiID,
    flags: ImGuiNavHighlightFlags = ImGuiNavHighlightFlags.TypeDefault.ImGuiNavHighlightFlags): void {.importc: "igRenderNavHighlight".}
proc igRenderRectFilledRangeH*(draw_list: ptr ImDrawList, rect: ImRect,
    col: uint32, x_start_norm: float32, x_end_norm: float32,
    rounding: float32): void {.importc: "igRenderRectFilledRangeH".}
proc igRenderRectFilledWithHole*(draw_list: ptr ImDrawList, outer: ImRect,
    inner: ImRect, col: uint32,
    rounding: float32): void {.importc: "igRenderRectFilledWithHole".}
proc igRenderText*(pos: ImVec2, text: cstring, text_end: cstring = nil,
    hide_text_after_hash: bool = true): void {.importc: "igRenderText".}
proc igRenderTextClipped*(pos_min: ImVec2, pos_max: ImVec2, text: cstring,
    text_end: cstring, text_size_if_known: ptr ImVec2, align: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2,
    clip_rect: ptr ImRect = nil): void {.importc: "igRenderTextClipped".}
proc igRenderTextClippedEx*(draw_list: ptr ImDrawList, pos_min: ImVec2,
    pos_max: ImVec2, text: cstring, text_end: cstring,
    text_size_if_known: ptr ImVec2, align: ImVec2 = ImVec2(x: 0, y: 0).ImVec2,
    clip_rect: ptr ImRect = nil): void {.importc: "igRenderTextClippedEx".}
proc igRenderTextEllipsis*(draw_list: ptr ImDrawList, pos_min: ImVec2,
    pos_max: ImVec2, clip_max_x: float32, ellipsis_max_x: float32,
    text: cstring, text_end: cstring,
    text_size_if_known: ptr ImVec2): void {.importc: "igRenderTextEllipsis".}
proc igRenderTextWrapped*(pos: ImVec2, text: cstring, text_end: cstring,
    wrap_width: float32): void {.importc: "igRenderTextWrapped".}
proc igResetMouseDragDelta*(button: ImGuiMouseButton = 0.ImGuiMouseButton): void {.importc: "igResetMouseDragDelta".}
proc igSameLine*(offset_from_start_x: float32 = 0.0f,
    spacing: float32 = -1.0f): void {.importc: "igSameLine".}
...
proc igScrollToBringRectIntoViewNonUDT*(pOut: ptr ImVec2,
    ...
    item_rect: ImRect): void {.importc: "igScrollToBringRectIntoView".}
proc igScrollbar*(axis: ImGuiAxis): void {.importc: "igScrollbar".}
proc igScrollbarEx*(bb: ImRect, id: ImGuiID, axis: ImGuiAxis,
    p_scroll_v: ptr float32, avail_v: float32, contents_v: float32,
    flags: ImDrawFlags): bool {.importc: "igScrollbarEx".}
proc igSelectable*(label: cstring, selected: bool = false,
    flags: ImGuiSelectableFlags = 0.ImGuiSelectableFlags, size: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2): bool {.importc: "igSelectable_Bool".}
proc igSelectable*(label: cstring, p_selected: ptr bool,
    flags: ImGuiSelectableFlags = 0.ImGuiSelectableFlags, size: ImVec2 = ImVec2(
    x: 0, y: 0).ImVec2): bool {.importc: "igSelectable_BoolPtr".}
...
proc igSetAllocatorFunctions*(alloc_func: ImGuiMemAllocFunc,
    ...
    user_data: pointer = nil): void {.importc: "igSetAllocatorFunctions".}
...
proc igSetColumnOffset*(column_index: int32,
    offset_x: float32): void {.importc: "igSetColumnOffset".}
proc igSetColumnWidth*(column_index: int32,
    width: float32): void {.importc: "igSetColumnWidth".}
...
proc igSetDragDropPayload*(`type`: cstring, data: pointer, sz: uint,
    cond: ImGuiCond = 0.ImGuiCond): bool {.importc: "igSetDragDropPayload".}
...
proc igSetNavID*(id: ImGuiID, nav_layer: ImGuiNavLayer, focus_scope_id: ImGuiID,
    rect_rel: ImRect): void {.importc: "igSetNavID".}
...
proc igSetNextWindowCollapsed*(collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetNextWindowCollapsed".}
...
proc igSetNextWindowPos*(pos: ImVec2, cond: ImGuiCond = 0.ImGuiCond,
    pivot: ImVec2 = ImVec2(x: 0,
    y: 0).ImVec2): void {.importc: "igSetNextWindowPos".}
...
proc igSetNextWindowSizeConstraints*(size_min: ImVec2, size_max: ImVec2,
    ...
    custom_callback_data: pointer = nil): void {.importc: "igSetNextWindowSizeConstraints".}
proc igSetScrollFromPosX*(local_x: float32,
    center_x_ratio: float32 = 0.5f): void {.importc: "igSetScrollFromPosX_Float".}
proc igSetScrollFromPosX*(window: ptr ImGuiWindow, local_x: float32,
    center_x_ratio: float32): void {.importc: "igSetScrollFromPosX_WindowPtr".}
proc igSetScrollFromPosY*(local_y: float32,
    center_y_ratio: float32 = 0.5f): void {.importc: "igSetScrollFromPosY_Float".}
proc igSetScrollFromPosY*(window: ptr ImGuiWindow, local_y: float32,
    center_y_ratio: float32): void {.importc: "igSetScrollFromPosY_WindowPtr".}
...
proc igSetScrollX*(window: ptr ImGuiWindow,
    scroll_x: float32): void {.importc: "igSetScrollX_WindowPtr".}
proc igSetScrollY*(scroll_y: float32): void {.importc: "igSetScrollY_Float".}
proc igSetScrollY*(window: ptr ImGuiWindow,
    scroll_y: float32): void {.importc: "igSetScrollY_WindowPtr".}
...
proc igSetWindowCollapsed*(collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowCollapsed_Bool".}
proc igSetWindowCollapsed*(name: cstring, collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowCollapsed_Str".}
proc igSetWindowCollapsed*(window: ptr ImGuiWindow, collapsed: bool,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowCollapsed_WindowPtr".}
...
proc igSetWindowHitTestHole*(window: ptr ImGuiWindow, pos: ImVec2,
    size: ImVec2): void {.importc: "igSetWindowHitTestHole".}
proc igSetWindowPos*(pos: ImVec2, cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowPos_Vec2".}
proc igSetWindowPos*(name: cstring, pos: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowPos_Str".}
proc igSetWindowPos*(window: ptr ImGuiWindow, pos: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowPos_WindowPtr".}
proc igSetWindowSize*(size: ImVec2, cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowSize_Vec2".}
proc igSetWindowSize*(name: cstring, size: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowSize_Str".}
proc igSetWindowSize*(window: ptr ImGuiWindow, size: ImVec2,
    cond: ImGuiCond = 0.ImGuiCond): void {.importc: "igSetWindowSize_WindowPtr".}
proc igShadeVertsLinearColorGradientKeepAlpha*(draw_list: ptr ImDrawList,
    ...
    gradient_p1: ImVec2, col0: uint32,
    col1: uint32): void {.importc: "igShadeVertsLinearColorGradientKeepAlpha".}
proc igShadeVertsLinearUV*(draw_list: ptr ImDrawList, vert_start_idx: int32,
    vert_end_idx: int32, a: ImVec2, b: ImVec2, uv_a: ImVec2, uv_b: ImVec2,
    clamp: bool): void {.importc: "igShadeVertsLinearUV".}
...
proc igSliderAngle*(label: cstring, v_rad: ptr float32,
    v_degrees_min: float32 = -360.0f, v_degrees_max: float32 = +360.0f,
    format: cstring = "%.0f deg",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderAngle".}
proc igSliderBehavior*(bb: ImRect, id: ImGuiID, data_type: ImGuiDataType,
    p_v: pointer, p_min: pointer, p_max: pointer, format: cstring,
    flags: ImGuiSliderFlags,
    out_grab_bb: ptr ImRect): bool {.importc: "igSliderBehavior".}
proc igSliderFloat*(label: cstring, v: ptr float32, v_min: float32,
    v_max: float32, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderFloat".}
proc igSliderFloat2*(label: cstring, v: var array[2, float32], v_min: float32,
    v_max: float32, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderFloat2".}
proc igSliderFloat3*(label: cstring, v: var array[3, float32], v_min: float32,
    v_max: float32, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderFloat3".}
proc igSliderFloat4*(label: cstring, v: var array[4, float32], v_min: float32,
    v_max: float32, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderFloat4".}
proc igSliderInt*(label: cstring, v: ptr int32, v_min: int32, v_max: int32,
    format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderInt".}
proc igSliderInt2*(label: cstring, v: var array[2, int32], v_min: int32,
    v_max: int32, format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderInt2".}
proc igSliderInt3*(label: cstring, v: var array[3, int32], v_min: int32,
    v_max: int32, format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderInt3".}
proc igSliderInt4*(label: cstring, v: var array[4, int32], v_min: int32,
    v_max: int32, format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderInt4".}
proc igSliderScalar*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    p_min: pointer, p_max: pointer, format: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderScalar".}
proc igSliderScalarN*(label: cstring, data_type: ImGuiDataType, p_data: pointer,
    components: int32, p_min: pointer, p_max: pointer, format: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igSliderScalarN".}
...
proc igSplitterBehavior*(bb: ImRect, id: ImGuiID, axis: ImGuiAxis,
    size1: ptr float32, size2: ptr float32, min_size1: float32,
    min_size2: float32, hover_extend: float32 = 0.0f,
    hover_visibility_delay: float32 = 0.0f): bool {.importc: "igSplitterBehavior".}
...
proc igTabBarCloseTab*(tab_bar: ptr ImGuiTabBar,
    tab: ptr ImGuiTabItem): void {.importc: "igTabBarCloseTab".}
proc igTabBarFindTabByID*(tab_bar: ptr ImGuiTabBar,
    tab_id: ImGuiID): ptr ImGuiTabItem {.importc: "igTabBarFindTabByID".}
...
proc igTabBarQueueReorder*(tab_bar: ptr ImGuiTabBar, tab: ptr ImGuiTabItem,
    offset: int32): void {.importc: "igTabBarQueueReorder".}
proc igTabBarQueueReorderFromMousePos*(tab_bar: ptr ImGuiTabBar,
    tab: ptr ImGuiTabItem,
    mouse_pos: ImVec2): void {.importc: "igTabBarQueueReorderFromMousePos".}
proc igTabBarRemoveTab*(tab_bar: ptr ImGuiTabBar,
    tab_id: ImGuiID): void {.importc: "igTabBarRemoveTab".}
proc igTabItemBackground*(draw_list: ptr ImDrawList, bb: ImRect,
    flags: ImGuiTabItemFlags,
    col: uint32): void {.importc: "igTabItemBackground".}
...
proc igTabItemCalcSizeNonUDT*(pOut: ptr ImVec2, label: cstring,
    has_close_button: bool): void {.importc: "igTabItemCalcSize".}
...
proc igTabItemLabelAndCloseButton*(draw_list: ptr ImDrawList, bb: ImRect,
    flags: ImGuiTabItemFlags, frame_padding: ImVec2, label: cstring,
    tab_id: ImGuiID, close_button_id: ImGuiID, is_contents_visible: bool,
    out_just_closed: ptr bool,
    out_text_clipped: ptr bool): void {.importc: "igTabItemLabelAndCloseButton".}
proc igTableBeginApplyRequests*(table: ptr ImGuiTable): void {.importc: "igTableBeginApplyRequests".}
proc igTableBeginCell*(table: ptr ImGuiTable,
    column_n: int32): void {.importc: "igTableBeginCell".}
proc igTableBeginInitMemory*(table: ptr ImGuiTable,
    columns_count: int32): void {.importc: "igTableBeginInitMemory".}
...
proc igTableFixColumnSortDirection*(table: ptr ImGuiTable,
    column: ptr ImGuiTableColumn): void {.importc: "igTableFixColumnSortDirection".}
...
proc igTableGetCellBgRectNonUDT*(pOut: ptr ImRect, table: ptr ImGuiTable,
    column_n: int32): void {.importc: "igTableGetCellBgRect".}
...
proc igTableGetColumnName*(table: ptr ImGuiTable,
    column_n: int32): cstring {.importc: "igTableGetColumnName_TablePtr".}
proc igTableGetColumnNextSortDirection*(
  column: ptr ImGuiTableColumn): ImGuiSortDirection {.importc: "igTableGetColumnNextSortDirection".}
proc igTableGetColumnResizeID*(table: ptr ImGuiTable, column_n: int32,
    instance_no: int32 = 0): ImGuiID {.importc: "igTableGetColumnResizeID".}
proc igTableGetColumnWidthAuto*(table: ptr ImGuiTable,
    column: ptr ImGuiTableColumn): float32 {.importc: "igTableGetColumnWidthAuto".}
...
proc igTableGetMaxColumnWidth*(table: ptr ImGuiTable,
    column_n: int32): float32 {.importc: "igTableGetMaxColumnWidth".}
...
proc igTableNextRow*(row_flags: ImGuiTableRowFlags = 0.ImGuiTableRowFlags,
    min_row_height: float32 = 0.0f): void {.importc: "igTableNextRow".}
...
proc igTableSetBgColor*(target: ImGuiTableBgTarget, color: uint32,
    column_n: int32 = -1): void {.importc: "igTableSetBgColor".}
proc igTableSetColumnEnabled*(column_n: int32,
    v: bool): void {.importc: "igTableSetColumnEnabled".}
...
proc igTableSetColumnSortDirection*(column_n: int32,
    ...
    append_to_sort_specs: bool): void {.importc: "igTableSetColumnSortDirection".}
proc igTableSetColumnWidth*(column_n: int32,
    width: float32): void {.importc: "igTableSetColumnWidth".}
proc igTableSetColumnWidthAutoAll*(table: ptr ImGuiTable): void {.importc: "igTableSetColumnWidthAutoAll".}
proc igTableSetColumnWidthAutoSingle*(table: ptr ImGuiTable,
    column_n: int32): void {.importc: "igTableSetColumnWidthAutoSingle".}
proc igTableSettingsCreate*(id: ImGuiID,
    columns_count: int32): ptr ImGuiTableSettings {.importc: "igTableSettingsCreate".}
...
proc igTableSetupColumn*(label: cstring,
    ...
    init_width_or_weight: float32 = 0.0f,
    user_id: ImGuiID = 0.ImGuiID): void {.importc: "igTableSetupColumn".}
proc igTableSetupDrawChannels*(table: ptr ImGuiTable): void {.importc: "igTableSetupDrawChannels".}
proc igTableSetupScrollFreeze*(cols: int32,
    rows: int32): void {.importc: "igTableSetupScrollFreeze".}
...
proc igTableUpdateColumnsWeightFromWidth*(
  table: ptr ImGuiTable): void {.importc: "igTableUpdateColumnsWeightFromWidth".}
...
proc igTempInputScalar*(bb: ImRect, id: ImGuiID, label: cstring,
    data_type: ImGuiDataType, p_data: pointer, format: cstring,
    p_clamp_min: pointer = nil,
    p_clamp_max: pointer = nil): bool {.importc: "igTempInputScalar".}
proc igTempInputText*(bb: ImRect, id: ImGuiID, label: cstring, buf: cstring,
    buf_size: int32,
    flags: ImGuiInputTextFlags): bool {.importc: "igTempInputText".}
...
proc igTextEx*(text: cstring, text_end: cstring = nil,
    flags: ImGuiTextFlags = 0.ImGuiTextFlags): void {.importc: "igTextEx".}
...
proc igTreeNodeBehavior*(id: ImGuiID, flags: ImGuiTreeNodeFlags, label: cstring,
    label_end: cstring = nil): bool {.importc: "igTreeNodeBehavior".}
proc igTreeNodeBehaviorIsOpen*(id: ImGuiID,
    flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.importc: "igTreeNodeBehaviorIsOpen".}
proc igTreeNodeEx*(label: cstring, flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool {.importc: "igTreeNodeEx_Str".}
proc igTreeNodeEx*(str_id: cstring, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeEx_StrStr", varargs.}
proc igTreeNodeEx*(ptr_id: pointer, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeEx_Ptr", varargs.}
proc igTreeNodeExV*(str_id: cstring, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExV_Str", varargs.}
proc igTreeNodeExV*(ptr_id: pointer, flags: ImGuiTreeNodeFlags,
    fmt: cstring): bool {.importc: "igTreeNodeExV_Ptr", varargs.}
...
proc igUpdateWindowParentAndRootLinks*(window: ptr ImGuiWindow,
    ...
    parent_window: ptr ImGuiWindow): void {.importc: "igUpdateWindowParentAndRootLinks".}
proc igVSliderFloat*(label: cstring, size: ImVec2, v: ptr float32,
    v_min: float32, v_max: float32, format: cstring = "%.3f",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igVSliderFloat".}
proc igVSliderInt*(label: cstring, size: ImVec2, v: ptr int32, v_min: int32,
    v_max: int32, format: cstring = "%d",
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igVSliderInt".}
proc igVSliderScalar*(label: cstring, size: ImVec2, data_type: ImGuiDataType,
    p_data: pointer, p_min: pointer, p_max: pointer, format: cstring = nil,
    flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool {.importc: "igVSliderScalar".}
...
proc igValue*(prefix: cstring, v: float32,
    float_format: cstring = nil): void {.importc: "igValue_Float".}
...
proc igStyleColorsCherry*(dst: ptr ImGuiStyle = nil): void =
  ...
  const ImVec4 = proc(x: float32, y: float32, z: float32,
      w: float32): ImVec4 = ImVec4(x: x, y: y, z: z, w: w)
